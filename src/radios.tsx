import { P, Small } from 'fonts';
import { Div } from 'html';
import { iRadio, iRadioInput, iRadioLabel, iRadioWrapper } from 'types/radios.types';
...
export const RadioWrapper = ({
	...
	const base = {
		...
		border: 'border',
		borderColor: active ? 'border-blue-500 dark:border-orange-500' : 'border-gray-400',
